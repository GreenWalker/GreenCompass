...
public class VersionProtocolControl1_7_R3 implements VersionProtocol, NBTVersion {

    private static VersionProtocolControl1_7_R3 instance;

    private VersionProtocolControl1_7_R3(){
    }

    public static VersionProtocolControl1_7_R3 getInstance(){
        if(null == instance){
            instance = new VersionProtocolControl1_7_R3();
        }
        return instance;
    }
